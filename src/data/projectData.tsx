export const PROJECTS = [
  {
    ...
    longDescription:
      'A simple flashcard web application designed for studying. Provides the ability to add an extensive range of questions into an account and includes a randomized order for each quiz.',
  ...
  },
  {
    ...
    longDescription:
      'A global scale covid-19 tracker of deaths, cases, and recoveries using a COVID-19 API. Includes sorted charts and summaries from a wide variety of Countries.',
  ...
  },
  {
    ...
    description: 'Streetwear reselling e-commerce website.',
    longDescription:
      'A shopify e-commerce website used to resell the latest streetwear from a local business in Ottawa, Canada. Anything from shoes, t-shirts, hoodies, sweatshirts, or pants.',
  ...
  },
  {
    ...
    longDescription:
      'A web agency landing page used as a means to provide details about the company and its services to potential clients.',
  ...
  },
  {
    ...
    longDescription:
      'A mobile application that helps find, manage, and connect volunteer opportunities for both students and organizations. Available in both Ottawa and Toronto.',
    langs: ['React Native', 'Firebase'],
    media: null,
    links: [
      { website: 'https://icontribute.community/#/' },
      { android: 'https://play.google.com/store/apps/details?id=com.icontribute' },
